import{j as t}from"./jsx-runtime-dZDNEfLr.js";import{B as c}from"./Button-DTscd2NO.js";import{f as m}from"./feather-sprite-BqdsxI4L.js";import"./iframe-DxOFCZSE.js";import"./preload-helper-PPVm8Dsz.js";const y={title:"Molecules/Button",component:c,parameters:{layout:"centered"},tags:["autodocs"],argTypes:{onClick:{action:"clicked"},label:{type:"string"}}},r={args:{primary:!0,label:"Click me",iconName:`${m}#save`}},e={...r,args:{...r.args,primary:!1}},a={...r,args:{...r.args,size:"large"}},s={...r,args:{...r.args,size:"small"}},n={args:{size:"icon",iconName:"#save"}},o={args:{primary:!0,label:"Click me",iconName:`${m}#save`},render(i){return t.jsx(c,{...i,children:t.jsx("div",{children:t.jsx("span",{style:{marginLeft:"5px"},children:"Test Button"},"label")})})}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  args: {
    primary: true,
    label: 'Click me',
