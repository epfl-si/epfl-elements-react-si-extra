import{j as t}from"./jsx-runtime-JREzBMnd.js";import{B as c}from"./Button-ChbGk0Yc.js";import"./iframe-DGdu2PBg.js";import"./preload-helper-BJiQSKF8.js";import"./feather-sprite-BJeC_hki.js";const d={title:"Molecules/Button",component:c,parameters:{layout:"centered"},tags:["autodocs"],argTypes:{onClick:{action:"clicked"},label:{type:"string"}}},r={args:{primary:!0,label:"Click me",iconName:"#save"}},e={...r,args:{...r.args,primary:!1}},a={...r,args:{...r.args,size:"large"}},s={...r,args:{...r.args,size:"small"}},n={args:{size:"icon",iconName:"#save"}},o={args:{primary:!0,label:"Click me",iconName:"#save"},render(m){return t.jsx(c,{...m,children:t.jsx("div",{children:t.jsx("span",{style:{marginLeft:"5px"},children:"Test Button"},"label")})})}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  args: {
    primary: true,
    label: 'Click me',
    iconName: \`#save\`
